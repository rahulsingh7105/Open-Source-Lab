...
Developers :Rahul Singh, Manu, Vijay Vardhan
...
option_2 = Label (frame_topic , text = '2- Units of physical Quantities' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
option_2.place(x = 30 , y = 160)

button_opt_2 = Button (frame_topic , text = 'Proceed' , image = front , relief = "flat" , bg = c1 , command = topic_4)
button_opt_2.place(x = 350 , y = 160)

option_3 = Label (frame_topic , text = '3-  Input Output Devices ' , font = 'Verdana 15 italic' ,bg = c1 , fg= c2)
option_3.place(x=30 , y = 200)

button_opt_3 = Button (frame_topic , text = 'Proceed' , image = front , relief = "flat" , bg = c1 , command = topic_5)
